 ...
 * @Description2: ESP32 kamera za nadzorni automobil
 */
...
const int Forward         = 92;                               // napred
const int Backward        = 163;                              // nazad
const int Turn_Left       = 172;                              // pomeranje ulevo
const int Turn_Right      = 83;                               // pomeranje udesno
const int Top_Left        = 20;                               // kretanje gore-levo
const int Bottom_Left     = 129;                              // kretanje dole-levo
const int Top_Right       = 72;                               // kretanje gore-desno
const int Bottom_Right    = 34;                               // kretanje dole-desno
const int Stop            = 0;                                // stop
const int Contrarotate    = 172;                              // rotacija suprotno od kazaljke na satu
const int Clockwise       = 83;                               // rotacija u smeru kazaljke na satu
const int Moedl1          = 25;                               // režim 1
const int Moedl2          = 26;                               // režim 2
const int Moedl3          = 27;                               // režim 3
const int Moedl4          = 28;                               // režim 4
const int MotorLeft       = 230;                              // servo levo
const int MotorRight      = 231;                              // servo desno
...
typedef struct
{
    size_t size;  // broj vrednosti koje se koriste za filtriranje
    size_t index; // indeks trenutne vrednosti
    size_t count; // broj vrednosti
    int sum;
    int *values; // niz koji se popunjava vrednostima
} ra_filter_t;
...
static esp_err_t index_handler(httpd_req_t *req)
{
    ...
    page += "<p align=center>";
    page += "<button style=background-color:lightgrey;width:90px;height:40px onmousedown=getsend('motorleft') onmouseup=getsend('stop') ontouchstart=getsend('motorleft') ontouchend=getsend('stop') ><b>MotorLeft</b></button>&nbsp;";
    page += "<button style=background-color:lightgrey;width:90px;height:40px onmousedown=getsend('go') onmouseup=getsend('stop') ontouchstart=getsend('go') ontouchend=getsend('stop') ><b>Forward</b></button>&nbsp;";
    page += "<button style=background-color:lightgrey;width:90px;height:40px onmousedown=getsend('motorright') onmouseup=getsend('stop') ontouchstart=getsend('motorright') ontouchend=getsend('stop') ><b>MotorRight</b></button>";
    page += "</p>";

    page += "<p align=center>";
    page += "<button style=background-color:lightgrey;width:90px;height:40px; onmousedown=getsend('Contrarotate') onmouseup=getsend('stop') ontouchstart=getsend('Contrarotate') ontouchend=getsend('stop')><b>Left</b></button>&nbsp;";
    // page += "<button style=background-color:lightgrey;width:90px;height:40px; onmousedown=getsend('clockwise') onmouseup=getsend('stop') ontouchstart=getsend('clockwise') ontouchend=getsend('stop')><b>Cloc</b></button>&nbsp;";
    page += "<button style=background-color:indianred;width:90px;height:40px onmousedown=getsend('stop') onmouseup=getsend('stop')><b>Stop</b></button>&nbsp;";
    page += "<button style=background-color:lightgrey;width:90px;height:40px; onmousedown=getsend('clockwise') onmouseup=getsend('stop') ontouchstart=getsend('clockwise') ontouchend=getsend('stop')><b>Right</b></button>";
    page += "</p>";
...
static esp_err_t Contrarotate_handler(httpd_req_t *req)        // 逆时针原地旋转
{
...
//////////////////////////////new/////////////////////////////////
    ...
    httpd_uri_t Contrarotate_uri = {           // 逆时针原地旋转
        .uri = "/Contrarotate",
        .method = HTTP_GET,
        .handler = Contrarotate_handler,       
        .user_ctx = NULL};
...
//////////////////////////////new/////////////////////////////////
    ...
    if (httpd_start(&camera_httpd, &config) == ESP_OK)
    {
        ...
        //////////////////////////////new/////////////////////////////////
        httpd_register_uri_handler(camera_httpd, &Contrarotate_uri);
